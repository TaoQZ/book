...
logfile="full_database_backup_${current_date}.log"
...
filename=full_database_backup_${current_date}.tar.gz

# 压缩备份文件和日志文件为 tar 包
echo "开始压缩备份文件..."
tarfile="${backup_dir}/full_database_backup_${current_date}.tar.gz"
# 普通压缩
